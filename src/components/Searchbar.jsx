  ...
  return (
    <div className="flex flex-col md:flex-row items-center bg-natural-4 dark:bg-black-2 rounded-xl py-3 px-4 md:divide-x-2 divide-y-2 md:divide-y-0 dark:divide-black-3 h-full justify-between gap-4">
      ...
      <div className="flex w-full md:w-1/3 justify-between pt-3 md:pt-0">
        <button type="button" className="flex cursor-pointer select-none w-full" onClick={() => setIsOpen((prev) => !prev)}>
          <p className="flex gap-x-2 text-natural-2 md:px-2">
            <PinIcon />
            Select Location
          </p>
        </button>
      ...
      <div className="flex md:px-4 w-full md:w-1/5 pt-3 md:pt-0">
        <div className="mr-2">
          <BriefcaseIcon />
        </div>
