...
const FeaturedCompanyCard = ({
  ...
  return (
    <div className="bg-white p-4 rounded-xl flex flex-col space-y-8 w-full mr-3 last:mr-0">
      <div className="flex items-center space-x-3">
        ...
        <div className="flex flex-col space-y-1">
          ...
          <div className="flex items-center space-x-2">
            ...
            <div className="text-natural-2 font-bold text-base">
      ...
      <div className="flex flex-col space-y-2">
        <div className="flex gap-2 text-natural-2 font-bold">
          <PinIcon />
          {location}
        </div>
        <div className="flex gap-2 text-natural-2 font-bold">
