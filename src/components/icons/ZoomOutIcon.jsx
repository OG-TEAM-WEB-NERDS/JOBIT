...
const ZoomOutIcon = ({ size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path fillRule="evenodd" clipRule="evenodd" d="M14.5 12H7.5C7.224 12 7 11.6647 7 11.25C7 10.8353 7.224 10.5 7.5 10.5H14.5C14.7765 10.5 15 10.8353 15 11.25C15 11.6647 14.7765 12 14.5 12Z" fill="#92929D" />
  </svg>
